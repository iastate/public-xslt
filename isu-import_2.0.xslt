...
<xsl:stylesheet version="2.0"
                ...
                xmlns:isu="http://its.iastate.edu/function#">
                
    <xsl:function name="isu:wrap">
        <xsl:param name="stringVal"/>
        <xsl:param name="delimiter"/>
        <xsl:variable name="quot" select="'&quot;'" />
        <xsl:choose>
            <xsl:when test="contains($stringVal, $delimiter)">
                <xsl:value-of select="concat($quot, translate($stringVal, '\&quot;', ''), $quot)"/>
            </xsl:when>
            <xsl:otherwise><xsl:value-of select="$stringVal"/></xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:character-map name="LatinAsciiEquivalents">
        ...
        <xsl:output-character character="¡" string=""/> <!-- ! may be an option -->
        <xsl:output-character character="¢" string=""/> <!-- C/ may be acceptable -->
        <xsl:output-character character="£" string=""/> <!-- Translating to GBP might be acceptable if guaranteed usage only for British Pound -->
        <xsl:output-character character="¤" string=""/>
        <xsl:output-character character="¥" string=""/> <!-- Y= may be acceptable -->
        <xsl:output-character character="¦" string="|"/>
        <xsl:output-character character="§" string=""/> <!-- SS may be an option -->
        <xsl:output-character character="¨" string=" "/>
        <xsl:output-character character="©" string="(c)"/>
        <xsl:output-character character="ª" string="a"/>
        <xsl:output-character character="«" string="&lt;&lt;"/> <!-- Using a &quot; might be preferable for some usages-->
        <xsl:output-character character="¬" string=""/>
        <xsl:output-character character="­" string="-"/>
        <xsl:output-character character="®" string="(r)"/>
        <xsl:output-character character="¯" string=""/>
        <xsl:output-character character="°" string=""/> <!-- Depending on usage you may be able to use deg-->
        <xsl:output-character character="±" string="+/-"/>
        ...
        <xsl:output-character character="Ä" string="Ae"/> <!-- This is the German equivalent which is the most likely to be encountered. -->
        <xsl:output-character character="Å" string="Aa"/> <!-- Swedish transcription -->
        ...
        <xsl:output-character character="Ö" string="Oe"/> <!-- This is the German and Swedish equivalent which is the most likely to be encountered.  Finnish would use O -->
        <xsl:output-character character="×" string="×"/>
        <xsl:output-character character="Ø" string="Oe"/> <!-- This is the Swedish equivalent which is the most likely to be encountered.  Usage should be fine for Norwegian and Danish -->
        ...
        <xsl:output-character character="Ü" string="Ue"/> <!-- This is the German equivalent which is the most likely to be encountered.  Other languages may use U -->
        ...
        <xsl:output-character character="ô" string="o"/>
        <xsl:output-character character="õ" string="o"/>
        <xsl:output-character character="ö" string="oe"/> <!-- This is the German equivalent which is the most likely to be encountered -->
        <xsl:output-character character="÷" string="/"/>
        <xsl:output-character character="ø" string="oe"/> <!-- This is the Swedish equivalent which is the most likely to be encountered.  Usage should be fine for Norwegian and Danish -->
        <xsl:output-character character="ù" string="u"/>
        <xsl:output-character character="ú" string="u"/>
        <xsl:output-character character="û" string="u"/>
        <xsl:output-character character="ü" string="ue"/> <!-- This is the German equivalent which is the most likely to be encountered -->
        <xsl:output-character character="ý" string="y"/>
        <xsl:output-character character="þ" string="th"/>
        ...
        <xsl:output-character character="ď" string="d"/>
        <xsl:output-character character="Đ" string="Dj"/> <!-- This is the Serbian equivalent, Macedonian would use Gj -->
        <xsl:output-character character="đ" string="dj"/> <!-- This is the Serbian equivalent, Macedonian would use Gj -->
        ...
        <xsl:output-character character="ľ" string="l"/>
        <xsl:output-character character="Ŀ" string="L."/> <!-- Catalan punt volat, a hyphen may also be used instead of a period -->
        <xsl:output-character character="ŀ" string="l."/> <!-- Catalan punt volat, a hyphen may also be used instead of a period -->
        ...
        <xsl:output-character character="Ŋ" string="Ng"/> <!-- May vary depending on specific transliteration for languages that use the African Reference Alphabet -->
        <xsl:output-character character="ŋ" string="ng"/> <!-- May vary depending on specific transliteration for languages that use the African Reference Alphabet -->
